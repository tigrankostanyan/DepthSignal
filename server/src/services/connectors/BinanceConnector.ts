...
import { ExchangeId, MarketTicker, MarketType, OrderBookLevel, OrderBookSnapshot, Trade } from '../../types/index.js';
...
export class BinanceConnector extends BaseExchangeConnector {
  ...
  // Spot subscribed symbols property
