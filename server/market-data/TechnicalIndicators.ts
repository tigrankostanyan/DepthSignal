...
/**
 * 14-period Relative Strength Index (Wilder's smoothed method)
 * Returns undefined if fewer than period + 1 close prices are available.
 */
 ...
 * Uses True Range = max(H - L, |H - PrevClose|, |L - PrevClose|)
 * Returns undefined if fewer than period + 1 candles are available.
 */
